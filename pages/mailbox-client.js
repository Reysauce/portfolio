    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <motion.div
          ...
          <h2>Overview</h2>
          <p>
            Mailbox-client is used to compose email to anyone. It is build using
            React, Redux, Custom Hooks , Bootstrap , React Quill & Email JS. I
            build this project to demonstrate knowledge working in React, Redux
            , Custom Hooks & Bootstrap. User can sign-up & login using email &
            password. User can send email to anyone using the text editor build
            using React-Quill & email is send using Email JS. User can view all
            received, sent & unread mail.
          </p>
          ...
          <Link
            href="https://github.com/Reyessauceda18/mailBoxClient-react"
            target="_blank"
            rel="noreferrer">
        ...
        <motion.div
          ...
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1 ">
              ...
              <p className="text-gray-600 py-2 flex items-center">
                <RiRadioButtonFill className="pr-1" /> React-Quill
              </p>
              <p className="text-gray-600 py-2 flex items-center">
