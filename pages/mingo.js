    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <motion.div
          ...
          <h2>Overview</h2>
          <p>
            Mingo is group chat application where user can create group & have
            chat with multiple users. It is build using React Js, Typescript,
            Redux, Firebase Real-time Database , Firebase Authentication, Google
            Authentication & Material UI . I build this project to demonstrate
            knowledge working in React JS, Typescript, Redux & Firebase . User
            can sign-up & login using email & password or with google
            authentication. Users can update their profile. Users can create new
            group, delete & update the group.Users can view members of a group.
            User can send & received chat . And have chat with multiple users in
            a group.
          </p>
          <div className="mt-10 mb-5">
            <p className="font-bold mb-2 ">Functionalties:-</p>
          ...
          <Link
            href="https://github.com/Reyessauceda18/mingo-chatapplication"
            target="_blank"
            rel="noreferrer">
        ...
        <motion.div
          ...
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1 ">
              ...
              <p className="text-gray-600 py-2 flex items-center">
                <RiRadioButtonFill className="pr-1" /> Firebase Real-time
                Database
              </p>
              <p className="text-gray-600 py-2 flex items-center">
              ...
              <p className="text-gray-600 py-2 flex items-center">
                <RiRadioButtonFill className="pr-1" /> Firebase Google
                Authentication
              </p>
              <p className="text-gray-600 py-2 flex items-center">
