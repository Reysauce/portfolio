      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <motion.div
          ...
          <p>
            ...
            t-shirt, album & accessories. It is build using React, React Context
            API, Firebase Firestore, Firebase Rest Authentication, Material UI,
            React-Image-Magnify, React-elastic-carousel & React lazy loading. I
            build this project to demonstrate my knowledge in React, React
            Context API, Firestore database, API Integration & React lazy
            loading.User can sign-up & login using email & password. User can
            add to cart/remove from cart product, increase quantity, remove
            product , remove all product & add a review for the product. User
            can view cart, search for the product,filter by category & can see
            magnify image of the product .
          </p>
          ...
          <Link
            href="https://github.com/Reyessauceda18/react-ecommerce"
            target="_blank"
            rel="noreferrer">
