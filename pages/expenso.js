    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <motion.div
          ...
          <h2>Overview</h2>
          <p>
            Expenso is an expense tracker built using React JS, Redux/ Redux
            thunk, Chart JS , Firebase & Material UI . I build this project to
            demonstrate knowledge working in React JS & Redux . User can sign-up
            & login using email & password. User can add their income & their
            expenses. User can view their remaining balance and view line chart
            of all expenses, pie chart of income vs expense vs remaining balance
            & bar chart of expenses by category. User can verify their email,
            update their profile & password. User can also update & delete the
            expense & can download the csv file of all expense if they want to.
          </p>
          ...
          <Link
            href="https://github.com/Reyessauceda18/expenso-react"
            target="_blank"
            rel="noreferrer">
        ...
        <motion.div
          ...
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1 ">
              ...
              <p className="text-gray-600 py-2 flex items-center">
                <RiRadioButtonFill className="pr-1" /> Firebase REST
                Authentication
              </p>
              <p className="text-gray-600 py-2 flex items-center">
