      ...
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        ...
        <div>
          <ul className="hidden md:flex">
            ...
            <Link href="/ReyesResume .pdf" target={"_blank"} rel={"noreferrer"}>
          ...
          <div className="py-4 flex flex-col">
            ...
            <div className="pt-40">
              ...
              <div className="flex items-center justify-between my-5 w-full sm:w-[80%]">
                <a
                  href="https://github.com/Reyessauceda18"
                  target="_blank"
                  rel="noreferrer">
                ...
                <a
                  href="https://www.linkedin.com/in/reyes-sauceda-80730b1a8/"
                  target="_blank"
                  rel="noreferrer">
                  <div className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in duration-300">
                    <FaLinkedinIn />
                ...
                <Link
                  href="https://leetcode.com/ReyesPeshimam/"
                  target="_blank"
                  rel="noreferrer">
                  <div
                    onClick={() => setNav(!nav)}
                ...
                <Link href="/#contact">
                  <div
                    onClick={() => {
                      setNav(!nav);
                      window.location.href = "mailto:reyessauceda@gmail.com";
                    }}
                    className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in duration-300">
                    <AiOutlineMail />
                  </div>
